...
INSERT INTO `areas` (`id`, `name`, `longitude`, `latitude`) VALUES
(1, '台中', '120.6736480', '24.1477360');
...
(13, '2018_03_15_103728_create_places_table', 2),
...
(14, '2018_07_13_130355_place_suitable_time_fragment', 2);
...
CREATE TABLE IF NOT EXISTS `places` (
  ...
  `suitable_time_fragment_id` int(10) UNSIGNED NOT NULL,
...
--
-- 資料表結構 `place_suitable_time_fragment`
--

DROP TABLE IF EXISTS `place_suitable_time_fragment`;
CREATE TABLE IF NOT EXISTS `place_suitable_time_fragment` (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `fragment_name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- 資料表的匯出資料 `place_suitable_time_fragment`
--

INSERT INTO `place_suitable_time_fragment` (`id`, `fragment_name`) VALUES
(1, '全時段'),
(2, '早'),
(3, '中'),
(4, '晚');
...
INSERT INTO `users` (`id`, `name`, `avatar_id`, `email`, `password`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'p208p2002@gmail.com', NULL, 'p208p2002@gmail.com', '$2y$10$JV23b1zeaX3iTFfHxowJJOTByKktqmG3ocPPP61P9fymjEteN2L0W', NULL, '2018-07-13 04:32:11', '2018-07-13 04:32:11');
COMMIT;
